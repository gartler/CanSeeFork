/**
* @file zoe.cpp
* @brief ZOE specific functions
*/

#include "zoe.h"

/**
 * Returns the CANbus ID where an ISOTP message should be send to, given the CANbus ID
 * the answer will be received from.
 * @param responseId CANbus ID of the ECU when it's sending
 * @return CANbus ID of the ECU it's receiving commands on
 */
