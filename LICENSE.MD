CanSee licenses file
-------------------

    CanSee
    ESP32 / Arduino firmware as a fast CANbus access gateway for the CanZE app

    Copyright (C) 2015 - Jeroen Meijer
...
----------
    ...
    CANSEE (“THE SOFTWARE”) IS PROVIDED AS IS. USE THE SOFTWARE AT YOUR OWN RISK. THE AUTHORS MAKE NO WARRANTIES AS TO
